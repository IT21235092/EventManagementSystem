    ...
    <section class="home-section">
        <nav>
         ...
         <!-- Home content -->
               <div class="row">
    <div class="col-md-12">
      <form action="../addService5" method="post">
        ...
        <fieldset>  
          ...
          try{
        	  ...
        	  String sql5 = "select * from advertisement a, Vendor v where v.Vendor_ID = a.Vendor_ID and v.Type = 'Food and Drinks' and Status = 1";
