...
<div class="row justify-content-center">
    <div class="col-12 col-lg-10 col-xl-8 mx-auto">
        ...
        <div class="my-4">
            ...
            <form action = "http://localhost:8080/EventManagementSystem/Settings1" method = "post">
                <div class="row mt-5 align-items-center">
                    ...
                    <div class="col">
                        <div class="row align-items-center">
                            <div class="col-md-7">
                                <h4 class="mb-1">${cus.getOrg_Name()}</h4>
                ...
                <div class="form-group">
                        ...
                        <input type="text" id="Organization" name = "Organization" value = '${cus.getOrg_Name()}' class="form-control"/>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name = "phone" value = '${cus.phone }' id="phone" pattern = "[0-9]{10}" title="Enter a 10 digit number"/>
                </div>
