...
<html>
    <head>
        <link rel="stylesheet" href="${pageContext.request.contextPath}/CSS/adminFeedback.css">
        <!-- Boxicons CDN Link -->
    ...
    <section class="home-section">
       ...
       <div class="main">
            ...
            <label for="chk" aria-hidden="true">Feedbacks</label>

 	<c:forEach var = "feedback" items = "${feedback}"> 
            <div class="card">
                <!-- <img src="/w3images/team2.jpg" alt="John" style="width:100%"> -->
                <h1>${feedback.name}</h1>
                <p class="title">${feedback.email}</p>
                <p>${feedback.desc}</p>
                
                <p><button>Rating : ${feedback.rating} /5.0</button></p>
              </div>
